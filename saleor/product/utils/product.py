...
def user_purchased_product(user, product):
    ...
    Args:
        ...
        product: Товар (Product instance)

    Returns:
        bool: True если пользователь покупал товар, False в противном случае
    """
    ...
    # Проверка через OrderLine - ищем выполненные заказы пользователя
    # с товарами, которые относятся к данному product
