...
export const ProductReviewModerateDocument = gql`
  ...
  productReviewModerate(input: $input) {
    ...
    `;
export type ProductReviewModerateMutationFn = Apollo.MutationFunction<Types.ProductReviewModerateMutation, Types.ProductReviewModerateMutationVariables>;

/**
 * __useProductReviewModerateMutation__
 *
 * To run a mutation, you first call `useProductReviewModerateMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useProductReviewModerateMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [productReviewModerateMutation, { data, loading, error }] = useProductReviewModerateMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useProductReviewModerateMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<Types.ProductReviewModerateMutation, Types.ProductReviewModerateMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<Types.ProductReviewModerateMutation, Types.ProductReviewModerateMutationVariables>(ProductReviewModerateDocument, options);
      }
export type ProductReviewModerateMutationHookResult = ReturnType<typeof useProductReviewModerateMutation>;
export type ProductReviewModerateMutationResult = Apollo.MutationResult<Types.ProductReviewModerateMutation>;
export type ProductReviewModerateMutationOptions = Apollo.BaseMutationOptions<Types.ProductReviewModerateMutation, Types.ProductReviewModerateMutationVariables>;
export const ProductReviewsPendingDocument = gql`
...
/**
 * __useProductReviewsPendingQuery__
 *
 * To run a query within a React component, call `useProductReviewsPendingQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductReviewsPendingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductReviewsPendingQuery({
 *   variables: {
 *   },
 * });
 */
export function useProductReviewsPendingQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<Types.ProductReviewsPendingQuery, Types.ProductReviewsPendingQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<Types.ProductReviewsPendingQuery, Types.ProductReviewsPendingQueryVariables>(ProductReviewsPendingDocument, options);
      }
export function useProductReviewsPendingLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<Types.ProductReviewsPendingQuery, Types.ProductReviewsPendingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<Types.ProductReviewsPendingQuery, Types.ProductReviewsPendingQueryVariables>(ProductReviewsPendingDocument, options);
        }
export type ProductReviewsPendingQueryHookResult = ReturnType<typeof useProductReviewsPendingQuery>;
export type ProductReviewsPendingLazyQueryHookResult = ReturnType<typeof useProductReviewsPendingLazyQuery>;
export type ProductReviewsPendingQueryResult = Apollo.QueryResult<Types.ProductReviewsPendingQuery, Types.ProductReviewsPendingQueryVariables>;
export const ProductReviewsPublishedDocument = gql`
...
/**
 * __useProductReviewsPublishedQuery__
 *
 * To run a query within a React component, call `useProductReviewsPublishedQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductReviewsPublishedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductReviewsPublishedQuery({
 *   variables: {
 *   },
 * });
 */
export function useProductReviewsPublishedQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<Types.ProductReviewsPublishedQuery, Types.ProductReviewsPublishedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<Types.ProductReviewsPublishedQuery, Types.ProductReviewsPublishedQueryVariables>(ProductReviewsPublishedDocument, options);
      }
export function useProductReviewsPublishedLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<Types.ProductReviewsPublishedQuery, Types.ProductReviewsPublishedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<Types.ProductReviewsPublishedQuery, Types.ProductReviewsPublishedQueryVariables>(ProductReviewsPublishedDocument, options);
        }
export type ProductReviewsPublishedQueryHookResult = ReturnType<typeof useProductReviewsPublishedQuery>;
export type ProductReviewsPublishedLazyQueryHookResult = ReturnType<typeof useProductReviewsPublishedLazyQuery>;
export type ProductReviewsPublishedQueryResult = Apollo.QueryResult<Types.ProductReviewsPublishedQuery, Types.ProductReviewsPublishedQueryVariables>;
...
/**
 * __useTopProductSalesQuery__
 *
 * To run a query within a React component, call `useTopProductSalesQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopProductSalesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useTopProductSalesQuery(baseOptions: ApolloReactHooks.QueryHookOptions<Types.TopProductSalesQuery, Types.TopProductSalesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<Types.TopProductSalesQuery, Types.TopProductSalesQueryVariables>(TopProductSalesDocument, options);
      }
export function useTopProductSalesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<Types.TopProductSalesQuery, Types.TopProductSalesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<Types.TopProductSalesQuery, Types.TopProductSalesQueryVariables>(TopProductSalesDocument, options);
        }
export type TopProductSalesQueryHookResult = ReturnType<typeof useTopProductSalesQuery>;
...
/**
 * __useComplexDashboardStatsQuery__
 *
 * To run a query within a React component, call `useComplexDashboardStatsQuery` and pass it any options that fit your needs.
 * When your component renders, `useComplexDashboardStatsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useComplexDashboardStatsQuery(baseOptions: ApolloReactHooks.QueryHookOptions<Types.ComplexDashboardStatsQuery, Types.ComplexDashboardStatsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<Types.ComplexDashboardStatsQuery, Types.ComplexDashboardStatsQueryVariables>(ComplexDashboardStatsDocument, options);
      }
export function useComplexDashboardStatsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<Types.ComplexDashboardStatsQuery, Types.ComplexDashboardStatsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<Types.ComplexDashboardStatsQuery, Types.ComplexDashboardStatsQueryVariables>(ComplexDashboardStatsDocument, options);
        }
export type ComplexDashboardStatsQueryHookResult = ReturnType<typeof useComplexDashboardStatsQuery>;
export type ComplexDashboardStatsLazyQueryHookResult = ReturnType<typeof useComplexDashboardStatsLazyQuery>;
export type ComplexDashboardStatsQueryResult = Apollo.QueryResult<Types.ComplexDashboardStatsQuery, Types.ComplexDashboardStatsQueryVariables>;